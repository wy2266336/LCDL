...
def parse():
    ...
    parser.add_argument('-valid_path',default='data/BC2GM-IOB/devel.tsv',help='validation data path')
    parser.add_argument('-train_path',default='data/BC2GM-IOB/train.tsv',help='training data path')
    parser.add_argument('-test_path',default='data/BC2GM-IOB/test.tsv',help='testing data path')
    #parser.add_argument('-adj_file', default='data/MLEE/ADJ.json',help='event label co-occurrence matrix path')
    #parser.add_argument('-embed_file', default='data/MLEE/mlee_label_vec_300.json', help='event label embedding path')
